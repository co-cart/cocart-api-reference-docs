...
<img src="images/github.svg" width="20" height="20" alt="GitHub Mark Logo"> [Edit on GitHub](https://github.com/co-cart/co-cart-docs/blob/master/source/includes/cocart-v2/_restore-item-to-cart.md)
...
```shell
curl -X GET https://example.com/wp-json/cocart/v2/item \
...
$response = wp_remote_get( 'https://example.com/wp-json/cocart/v2/item', $args );
