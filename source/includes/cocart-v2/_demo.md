...
<img src="images/github.svg" width="20" height="20" alt="GitHub Mark Logo"> [Edit on GitHub](https://github.com/co-cart/co-cart-docs/blob/master/source/includes/cocart-v2/_demo.md)
...
Test authentication as a customer via the [basic method](#authentication-basic-authentication).
